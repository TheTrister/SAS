...
<head>
    ...
    <link href="<?php echo base_url();?>/assets/vvendors/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
            		...
            		<div class="card-body p-0">
            			...
            			<div class="row">
            				<div class="col-lg-6 d-none d-lg-block "
	            				style="background: url('http://localhost/pkl/tugas1/assets/600x800.jpg');
            				...
            				<div class="col-lg-6">
            					<div class="p-5">
            						...
            						<form class="user" method="POST" action="<?php echo base_url('Template/proses_login') ?>">
                                        ...
                                        <input type="submit"  class="btn btn-secondary btn-user btn-block" name="Kirim" value="Login">
                                    </form><br><br>
                                    <div class="text-center">
